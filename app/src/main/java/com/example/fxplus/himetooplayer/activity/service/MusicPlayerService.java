package com.example.fxplus.himetooplayer.activity.service;
...
public class MusicPlayerService extends Service {
    ...
    public static final String OPENAUDIO = "com.mitu.mobileplayer_OPENAUDIO";
    private ArrayList<MediaItem> mediaItems;
    private int position; //列表的位置
    private MediaPlayer mediaPlayer;//用于播放音乐
    private MediaItem mediaItem;//当前播放的文件对象
    /**
     * 顺序播放
     */
...
//                 mediaPlayer.release();
            ...
            try {
                ...
                mediaPlayer.setDataSource(mediaItem.getData());//播放地址
...
//            notifyChange(OPENAUDIO);
    ...
    //当播放歌曲的时候，在状态栏显示正在播放的音乐，点击的时候，可以进入到音乐播放页面
    manager = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
        Intent intent = new Intent(this, AudioPlayerAcitvity.class);
        intent.putExtra("Notification",true);
        PendingIntent pendingIntent = PendingIntent.getActivity(this,1,intent,PendingIntent.FLAG_CANCEL_CURRENT);
        Notification notification = new Notification.Builder(this)
                .setSmallIcon(R.drawable.notification_music_playing)
                .setContentTitle("觅途音乐")
